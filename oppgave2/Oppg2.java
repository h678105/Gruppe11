...
public class Oppg2 {
    ...
    public static void main(String[] args) {
        ...
        Function<Ansatt, Integer> lavLonnKronetillegg = a -> a.getAarslonn() < 500000 ? a.getAarslonn() + 15000
                : a.getAarslonn();
        ...
        Function<Ansatt, Integer> prosenttilleggForMenn = a -> a.getKjonn() == Kjonn.MANN
                ? (int) (a.getAarslonn() * 1.03)
                : a.getAarslonn();
